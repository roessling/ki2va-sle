...
%%% by Guido Rößling and Felix Broj.
%%%
\setcopyright{rightsretained}
\acmPrice{15.00}
\acmDOI{10.1145/3197091.3205809}
\acmYear{2018}
\copyrightyear{2018}
...
Both the avatar for the persona assigned to the user and six additional
...
score: 0 means no progress upwards, 1 results in a ``small step'' and 2 in a ``bigger step'' upwards.
In this way, the user can easily see that the progress upwards for the personas based
...
The course is available at \url{http://bit.ly/2IlNaXx} for viewing and commenting. Discussing only
requires entering an email address; no registration is needed.
